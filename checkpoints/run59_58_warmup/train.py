...
if __name__ == '__main__':
    ...
    train(
        ...
        out_dir='checkpoints/run59_58_warmup',
    )
    train(
        data_dir='data/dynarepo/dataset.h5', mode='teacher',
        device='mps', dtype=torch.float32, num_epochs=1000, valid_frac=0.1,
        batch_size=16, accum_size=1, chunk_size=1, lr_readout=1e-3, lr_scaffold=1e-3, patience=5,
        param_every=1, eval_every=1, checkpoint_every=5,
        # base_ckpt='checkpoints/run59_58_warmup/best.pt',
        out_dir='checkpoints/run60_59_train',
    )