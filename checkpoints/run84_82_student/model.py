...
class StudentModel(nn.Module):
    ...
    def forward(self, coords: torch.Tensor, residues: torch.Tensor, props: torch.Tensor, valid_masks: torch.Tensor, core_masks: torch.Tensor, ligand_masks: torch.Tensor, mode: Literal['inference', 'train', 'distill', 'embed'] = 'inference', chunk_size: int = 1, **kwargs):
