...
def train(data_dir: str, mode: Literal['pretrain', 'teacher', 'student'] = 'pretrain', 
    ...
    if mode == 'pretrain':
        ...
        loss_fn = InteractionLoss(0.001061, 6.777358, 17.148979, 11670.543898)
        ...
        model = TeacherModel().to(device).to(dtype)
        loss_fn = JointLoss([(InteractionLoss(0.001061, 6.777358, 17.148979, 11670.543898), 1.0), (AffinityLoss(), 1.0)]).to(dtype)
        dataset = TrajectoryDataset(data_dir, num_frames=num_frames)
...
if __name__ == '__main__':
    ...
    train(
        ...
        out_dir='checkpoints/run26_pretrain'
    )