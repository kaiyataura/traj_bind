...
class InteractionLoss(nn.Module):
    def __init__(self, vdw_std: float = 1.0, elec_std: float = 1.0, solv_std: float = 1.0, hbond_std: float = 1.0, active_weight: float = 1.0, inactive_weight: float = 0.1):
        super().__init__()
    ...
    def forward(self, interactions, interaction_targets, core_masks, **kwargs):
        ...
        mask = core_masks[:,None,None,:,None] & core_masks[:,None,:,None,None] # [B, T, N, N, 1]
