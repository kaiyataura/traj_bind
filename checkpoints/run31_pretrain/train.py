...
if __name__ == '__main__':
    ...
    train(
        ...
        device='mps', dtype=torch.float32, num_epochs=1000, valid_frac=0.1,
        batch_size=2, lr_readout=1e-3, lr_scaffold=5e-4,
        param_every=1, eval_every=1, checkpoint_every=10,
        out_dir='checkpoints/run30_pretrain'
    )
    train(
        data_dir='data/dynarepo/dataset.h5', mode='pretrain',
        device='mps', dtype=torch.float32, num_epochs=1000, valid_frac=0.1,
        batch_size=2, lr_readout=1e-3, lr_scaffold=5e-4,
        param_every=1, eval_every=1, checkpoint_every=10,
        out_dir='checkpoints/run31_pretrain',
        r_max=15.0
    )
    train(
        data_dir='data/dynarepo/dataset.h5', mode='pretrain',
        ...
        batch_size=2, lr_readout=1e-3, lr_scaffold=5e-4,
        param_every=1, eval_every=1, checkpoint_every=10,
        out_dir='checkpoints/run32_pretrain',
        r_max=15.0, num_layers=4
    )