...
if __name__ == '__main__':
    ...
    train(
        data_dir='data/dynarepo/dataset.h5', mode='teacher',
        device='mps', dtype=torch.float32, num_epochs=1000, valid_frac=0.1,
        batch_size=8, accum_size=1, chunk_size=1, num_frames=4, lr_head=1e-3, lr_gate=1e-3, lr_scaffold=1e-4, warmup_epochs=5, patience=10,
        param_every=1, eval_every=1, checkpoint_every=5,
        base_ckpt='checkpoints/run76_73_train/epoch_0.pt',
        out_dir='checkpoints/run76_73_train',
    )