...
class TrajectoryDataset(Dataset):
    def __init__(self, data_file: str, num_frames: int = 16, embeds_file: str | None = None):
    ...
    def __getitem__(self, index):
        ...
        indices = torch.randint(T, (self.num_frames,)) if T < self.num_frames else torch.randperm(T)[:self.num_frames]
