...
class SpatialAttention(nn.Module):
    def __init__(self, hidden_dim: int, num_heads: int = 8, dropout: float = 0.1):
        ...
        nn.init.zeros_(self.bias_mlp[-1].weight) # type: ignore
        ...
        nn.init.zeros_(self.node_update[-1].weight) # type: ignore
        nn.init.zeros_(self.node_update[-1].bias) # type: ignore
        ...
        nn.init.zeros_(self.edge_update[-1].weight) # type: ignore
        nn.init.zeros_(self.edge_update[-1].bias) # type: ignore
...
class TeacherModel(nn.Module):
    def __init__(self, hidden_dim: int = 128, dropout: float = 0.1, **kwargs):
        ...
        nn.init.zeros_(self.enthalpy_gate[-1].weight) # type: ignore
        nn.init.zeros_(self.enthalpy_gate[-1].bias) # type: ignore
        ...
        nn.init.zeros_(self.entropy_gate[-1].weight) # type: ignore
        nn.init.zeros_(self.entropy_gate[-1].bias) # type: ignore
